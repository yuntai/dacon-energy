...
docker stop tacotron2 || true && docker rm tacotron2 || true
...
docker run --shm-size=1g --rm --name colab --ulimit memlock=-1 --ulimit stack=67108864 -d --ipc=host --ip 0.0.0.0 -p 9999:8888 -v /mnt/tmp:/mnt/tmp -v /mnt/datasets:/mnt/datasets -v $(pwd):/workspace -v ${dataroot}:${dataroot} colab
